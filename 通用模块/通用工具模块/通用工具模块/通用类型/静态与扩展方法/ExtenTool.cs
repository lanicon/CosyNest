...
namespace System
{
    ...
    public static class ExtenTool
    {
        ...
        /// <param name="ThrEx">如果这个值为<see langword="true"/>，在转换失败时会抛出异常</param>
        /// <param name="NotConve">如果转换失败，而且不抛出异常，则返回这个值，默认为类型默认值</param>
        /// <returns></returns>
        [return: NotNullIfNotNull("Obj")]
        public static Ret? To<Ret>(this object? Obj, bool ThrEx = true, LazyPro<Ret>? NotConve = default)
        {
            var type = typeof(Ret);
            try
            {
        ...
        /// 前提条件是这两个委托签名必须相同
        /// </summary>
        /// <param name="OldDel">要转换的旧委托</param>
        /// <param name="NewType">新委托的类型</param>
        /// <returns></returns>
        public static Delegate To(this Delegate OldDel, Type NewType)
            => Delegate.CreateDelegate(NewType, OldDel.Target, OldDel.Method);
        #endregion
        #region 使用泛型标明新委托类型
        /// <summary>
        /// 将一个委托转换为另一种委托类型，
        ...
        /// <param name="OldDel">要转换的旧委托</param>
        /// <returns></returns>
        public static NewDel To<NewDel>(this Delegate OldDel)
            where NewDel : Delegate
            => (NewDel)OldDel.To(typeof(NewDel));
        #endregion
        #endregion
        #endregion
        #region 关于枚举
        ...
        /// <returns></returns>
        public static bool IsBusinessExceptions(this Exception exception)
            => exception.Data["IsBusinessExceptions"] is true;
        #endregion
        #region 设置异常为业务异常
        /// <summary>
        /// 将指定的异常设置为业务异常，并返回这个异常本身
        /// </summary>
        /// <typeparam name="Exception">异常的类型</typeparam>
        /// <param name="exception">要设置为业务异常的异常</param>
        /// <returns></returns>
        public static Exception ToBusinessExceptions<Exception>(this Exception exception)
            where Exception : System.Exception
        {
            exception.Data["IsBusinessExceptions"] = true;
            return exception;
        }
        #endregion
        #endregion
