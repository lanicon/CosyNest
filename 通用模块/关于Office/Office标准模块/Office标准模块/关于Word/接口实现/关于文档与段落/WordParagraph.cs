...
namespace System.Office.Word.Realize
{
    ...
    public abstract class WordParagraph : IWordParagraph
    {
        ...
        public void Delete()
        {
            ...
            Document.To<WordDocument>().CallLengthChange(Begin.Pos..Len, -Len);
        }
        #endregion
        #region 模板方法
        /// <summary>
        /// 删除段落的实际逻辑在这个方法中实现
        /// </summary>
        public abstract void DeleteRealize();
        #endregion
        #endregion
        #region 构造函数
        /// <summary>
        /// 用指定的文档和开始位置初始化对象
        /// </summary>
        /// <param name="doc">段落所属的文档</param>
        /// <param name="Begin">段落的开始位置</param>
        public WordParagraph(IWordDocument doc, int Begin)
        {
            this.Document = doc;
