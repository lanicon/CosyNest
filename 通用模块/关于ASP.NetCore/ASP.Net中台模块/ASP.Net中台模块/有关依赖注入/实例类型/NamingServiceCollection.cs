...
namespace Microsoft.Extensions.DependencyInjection
{
    ...
    class NamingServiceCollection<Service>
    {
        #region 储存服务的字典
        /// <summary>
        /// 这个字典可以通过名称来检索服务
        /// </summary>
        private Dictionary<string, Func<IServiceProvider, Service>> Services { get; }
        #endregion
        #region 服务请求对象
        /// <summary>
        /// 获取一个对象，
        ...
        #endregion
        #region 用来检索服务的委托
        /// <inheritdoc cref="NamingService{Service}"/>
        public Service NamingService(string serviceName)
